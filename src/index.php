...
try {
    // host=172.17.1.130;
    $pdo = new PDO('mysql:host=db;dbname=project', 'root', 'root');
    $pdo->exec('CREATE TABLE `foo` (`id` INT NOT NULL AUTO_INCREMENT, `text` VARCHAR(255), PRIMARY KEY (id)) ENGINE=InnoDB');
